        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input value="{{ old('code') }}" type="text"
                    class="title form-control @error('code') is-invalid @enderror" name="code" id="code">
                @error('code')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <textarea value="{{ old('supports') }}" type="text"
                    class="ckeditor form-control @error('supports') is-invalid @enderror" name="supports" id="supports" cols="30"
                    rows="10"></textarea>
                @error('supports')
                    <div class="invalid-feedback">
                        {{ $message }}
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <textarea value="{{ old('detail') }}" type="text"
                    class="ckeditor form-control @error('detail') is-invalid @enderror" name="detail" id="detail"
            ...
            <div class="row align-items-end my-2">
                ...
                <div class="col-2">
                    <button type="button" id="lfm" data-input="thumbnail" data-preview="holder"
                        class="btn btn-primary d-grid">Chọn ảnh</button>
                </div>
                <div class="col-md-3">
                    <img src="" alt="">
                </div>
